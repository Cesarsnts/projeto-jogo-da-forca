...
### 3.2 Funcionalidades Planejadas (Não foi aplicado)
...
| Etapa                  | Descrição                                                
|------------------------|----------------------------------------------------------|
| 1. Estrutura Inicial    | Setup do ambiente, interface básica com Tkinter e lógica 
| 2. Banco de Palavras e Interface Gráfica | Integração de palavras, canvas e feedback visual  
| 3. Funcionalidades Avançadas | Pontuação, histórico, níveis de dificuldade, persistência 
| 4. Testes e Finalização | Testes completos, refatoração e documentação            
| 5. Extensão Interface   | Possível migração ou acréscimo de outras interfaces (Pygame) 
...
- Uso de canva para desenho do cenário e forca com partes desenhadas progressivamente conforme erros;  
